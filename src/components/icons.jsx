...
// Helper base configurável para todos os ícones
const base = (children, { size = 24, strokeWidth = 1.8, style, className, active, color, ...props }) => {
  const iconColor = active ? '#2563eb' : (color || 'currentColor')
